...
let HydrothermalVenture2 = require('./Part2/adventPart2.ts');
...
//     });
    ...
    describe('HydrothermalVenture2', function () {
        it('should return 5', function () {
            const input: string = `0,9 -> 5,9
8,0 -> 0,8`;
            const result = HydrothermalVenture2.HydrothermalVenture(input);
            assert.equal(result, 5);
        });
